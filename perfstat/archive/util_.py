...
def OBV_calc(df, symbol, EMA_pd=10, tail_pd=5, norm_pd=30):
    ...
    # average EMA slopes of the last tail_pd days, default is 5 days
...
def dates_within_limits(index, date_start_limit=None, date_end_limit=None,
                        iloc_offset=None, verbose=False):
