...
from get_symbol_data_4 import get_symbol_data_4
...
# iloc_iteration = 20  # iloc_iteration = 0 results in 1 iteration
iloc_iteration = 10  # iloc_iteration = 0 results in 1 iteration, 1.3 hrs for 5
