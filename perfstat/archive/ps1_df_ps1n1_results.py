...
# date_end_limit = '2020-11-02'  # test
# date_end_limit = '2013-02-06'  # next colab run
# date_end_limit = '2020-12-24'
...
# delete df_symbols_close will force an update
if force_update_df_symbols_close:
    os.remove(path_data_dump + "df_symbols_close")
