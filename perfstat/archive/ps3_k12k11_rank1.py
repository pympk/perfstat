...
# v1 add for_loop for dates in dates_nyse
...
rows_OHLCV_display = 5  # number of rows of OHLCV to display
...
df_org = pickle_load(path_data_dump, filename_df)
...
for my_date in dates_nyse:
    ...
    if not df_sym.empty:
        ...
        sym_freq = [count for symbol, count in Counter(symbols).most_common()]
