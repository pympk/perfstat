...
print(df.columns, "\n")
print(df, "\n")
print(f"df.days_trade_delay.describe(): {df.days_trade_delay.describe()}\n")
...
risk_adj_rtn_close_end = df["close_end"].iloc[-1] / UI_close_end
risk_adj_rtn_close_delay = df["close_delay"].iloc[-1] / UI_close_delay
risk_adj_rtn_close_QQQ = df["close_QQQ"].iloc[-1] / UI_close_QQQ
...
ratio_risk_adj_rtn_end_QQQ = risk_adj_rtn_close_end / risk_adj_rtn_close_QQQ
ratio_risk_adj_rtn_delay_QQQ = risk_adj_rtn_close_delay / risk_adj_rtn_close_QQQ
print(f"ratio_risk_adj_rtn_end_QQQ: {ratio_risk_adj_rtn_end_QQQ:.4f}")
print(f"ratio_risk_adj_rtn_delay_QQQ: {ratio_risk_adj_rtn_delay_QQQ:.4f}\n")
ratio_rtn_close_end_QQQ = df["close_end"].iloc[-1] / df["close_QQQ"].iloc[-1]
ratio_rtn_close_delay_QQQ = df["close_delay"].iloc[-1] / df["close_QQQ"].iloc[-1]
print(f"ratio_rtn_close_end_QQQ: {ratio_rtn_close_end_QQQ:.4f}")
print(f"ratio_rtn_close_delay_QQQ: {ratio_rtn_close_delay_QQQ:.4f}\n")
