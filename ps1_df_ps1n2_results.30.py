...
# v30 replace symbols_with_csv_data with symbols_with_csv_data_n_unique_dates
#  replace get_symbol_data_4 with get_symbol_data_5 that added check for
...
from get_symbol_data_5 import get_symbol_data_5
...
def calc_perf_stats():
    ...
    count_total_symbols = len(symbols_with_csv_data_n_unique_dates)
...
def update_symbols_data():
    ...
    list_dump(
        symbols_with_csv_data_n_unique_dates,
        path_data_dump,
        "symbols_with_csv_data_n_unique_dates.txt",
    )
...
if force_update_df_symbols_close:  # force update
    ...
    if (
        ...
        symbols_with_csv_data_n_unique_dates = pickle_load(
            path_data_dump, "symbols_with_csv_data_n_unique_dates"
        )
...
if verbose:
    ...
    for i, symbol in enumerate(symbols_with_csv_data_n_unique_dates):
